...
import { AiOutlineLineChart, AiOutlineCode, AiOutlineRobot } from 'react-icons/ai';
  ...
  const slides = [
    {
      ...
      description: "Learn cutting-edge AI techniques with our comprehensive courses taught by industry experts",
    ...
    },
    {
      ...
      description: "Become a data expert with Python, R, machine learning, and data visualization",
      ...
      <div className="absolute bottom-8 left-0 right-0 flex justify-center gap-2">
        {slides.map((_, index) => (
          <button
            ...
            className={`w-3 h-3 rounded-full transition ${currentSlide === index ? 'bg-white scale-125' : 'bg-gray-400'}`}
